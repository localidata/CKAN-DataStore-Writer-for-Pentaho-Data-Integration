...
import org.ckan.client.localidata.ResourceUtils;
import org.ckan.client.resource.impl.Dataset;
import org.ckan.client.resource.impl.Group;
import org.ckan.client.resource.impl.Resource;
import org.ckan.client.resource.impl.Revision;
import org.ckan.client.resource.impl.User;
import org.ckan.client.result.CKANResult;
import org.ckan.client.result.impl.ActivityResult;
import org.ckan.client.result.impl.BooleanResult;
import org.ckan.client.result.impl.DataStore;
import org.ckan.client.result.impl.DatasetResult;
import org.ckan.client.result.impl.DatasetSearchResult;
import org.ckan.client.result.impl.FollowingResult;
import org.ckan.client.result.impl.GroupResult;
import org.ckan.client.result.impl.IntegerResult;
import org.ckan.client.result.impl.MembershipResult;
import org.ckan.client.result.impl.ResourceResult;
import org.ckan.client.result.impl.ResourceStatusResult;
import org.ckan.client.result.impl.RevisionResult;
import org.ckan.client.result.impl.StringResult;
import org.ckan.client.result.impl.UserResult;
import org.ckan.client.result.list.impl.ActivityList;
import org.ckan.client.result.list.impl.DatasetList;
import org.ckan.client.result.list.impl.LicenceList;
...
public final class Client
{
    ...
    */
    public <T> T getGsonObjectFromJson(Class<T> cls, String data, String action) throws CKANException
    {
    ...
    */
    ...
    /**
     * Method to running an api order to connection without port
     * @param uri URI to run
     * @param jsonParams parameters of execution
     * @return Result of execution api
     * @throws CKANException
     */
    protected String postAndReturnTheJSONWithoutPort(String uri, String jsonParams) throws CKANException
    {
        String json = this.connection.postWithoutPort(uri,jsonParams);
        if(DEBUG_ALL_CALLS||DEBUG)
        {
        	if (log!=null){
        		 HashMap hm  = gson.fromJson(json,HashMap.class);
        		 Boolean success = (Boolean)hm.get("success");
    ...
    */
    ...
    {
        GroupResult r = getGsonObjectFromJson(GroupResult.class,postAndReturnTheJSON("/api/action/group_create",getJsonFromGsonObject(group)),"createGroup");
        return r.result;
    }
    ...
    * @throws A CKANException if the request fails
    */
    public Dataset getDatasetName(String name) throws CKANException
    {
        DatasetResult dr = getGsonObjectFromJson(DatasetResult.class,postAndReturnTheJSON("/api/action/package_search","{\"name\":\""+name+"\"}"),"getDataset");
        return dr.result;
    }
     ...
     *
     * Retrieves the dataset with the given name, or ID, from the CKAN
     * connection specified in the Client constructor without parameters.
     *
     * @param  name The name or ID of the dataset to fetch
     * @returns The Dataset for the provided name.
     * @throws A CKANException if the request fails
     */
    public Dataset getDatasetWithoutParam(String dataSetName) throws CKANException
    {
    	 DatasetResult dr = getGsonObjectFromJson(DatasetResult.class,postAndReturnTheJSONWithoutPort("/api/3/action/package_show?id="+dataSetName,""),"getDataset");
    	 return dr.result;
    }
    ...
    */
    ...
    {    
    	 String json=ResourceUtils.updateResource(this.connection,  resourceID,  dataSetID,  path,   label,  format, description, timeout);
	...
	public DataStore createDataStore(DataStore ds) {
		// TODO Auto-generated method stub
		return null;
	}

	public DataStore upsertDataStore(DataStore ds, int i) {
		// TODO Auto-generated method stub
		return null;
	}
